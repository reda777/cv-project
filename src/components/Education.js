...
class Education extends Component {
  constructor(props) {
      ...
      rows: [
        {
          ...
          degreeDesc:
            "Degree description Degree description Degree description Degree description Degree description Degree description Degree description Degree description Degree description.",
        },
      ],
    };
    ...
    this.updateEduCount = this.props.updateEduCount;
  }
  handleChange(e) {
  ...
  handleAdd() {
    if (this.props.experienceCount !== 3 || this.props.educationCount !== 2) {
      if (this.props.educationCount < 3) {
        this.setState((state) => ({
  ...
  renderDegreeName(id) {
    ...
    let degreeNameDiv =
      renderPart === "degreeName" && renderId === id ? (
        <input
          type="text"
          id="degreeName"
          value={this.state.rows[id].degreeName}
          onChange={this.handleChange}
          onKeyDown={this.handleEnter}
        />
      ) : (
        <div className="degreeName" onClick={this.handleClick}>
          {this.state.rows[id].degreeName}
        </div>
      );
  ...
  renderDegreeYear(id) {
    ...
    const renderId = this.props.renderId;
    let degreeYearDiv =
      renderPart === "degreeYear" && renderId === id ? (
        <input
          type="text"
          id="degreeYear"
          value={this.state.rows[id].degreeYear}
          onChange={this.handleChange}
          onKeyDown={this.handleEnter}
        />
      ) : (
        <div className="degreeYear" onClick={this.handleClick}>
          {this.state.rows[id].degreeYear}
        </div>
      );
  ...
  renderDegreeSchool(id) {
    ...
    const renderId = this.props.renderId;
    let degreeSchoolDiv =
      renderPart === "degreeSchool" && renderId === id ? (
        <input
          type="text"
          id="degreeSchool"
          value={this.state.rows[id].degreeSchool}
          onChange={this.handleChange}
          onKeyDown={this.handleEnter}
        />
      ) : (
        <div className="degreeSchool" onClick={this.handleClick}>
          {this.state.rows[id].degreeSchool}
        </div>
      );
  ...
  renderDegreeDesc(id) {
    ...
    const renderId = this.props.renderId;
    let degreeDescDiv =
      renderPart === "degreeDesc" && renderId === id ? (
        <textarea
          type="text"
          id="degreeDesc"
          value={this.state.rows[id].degreeDesc}
          onChange={this.handleChange}
          onKeyDown={this.handleEnter}
        />
      ) : (
        <div className="degreeDesc" onClick={this.handleClick}>
          {this.state.rows[id].degreeDesc}
        </div>
      );
